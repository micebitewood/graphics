/*
	...
	slightly diffent from the Matrix.java in assignment 2
	the transform method return "this" so that we can type Matrix.translate().rotate().scale() in stead of separating them
*/
public class Matrix{
